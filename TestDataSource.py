...
class TestDataSource(unittest.TestCase):
    ...
    short_bill_list = []
    short_bill_list = [100, 109, 189, datetime.date('2005-07-14 18:53:00'), 'amendment', 'On the Amendment S.Amdt. 1222 to H.R. 2360 (Department of Homeland Security Appropriations Act, 2006)']
